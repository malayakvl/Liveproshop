...
const SidebarHeader: React.FC = () => {
    ...
    return (
        <div className="shadow-lg max-h-[50px] md:pb-0  md:shadow-none md:flex md:pr-4 md:mt-2 items-center align-middle">
            <div className="min-h-[55px] pt-[5px] pb-[10px] w-full text-right">
                {/*<div style={{ border: 'solid 1px' }} className="block-mobile">*/}
                <div className="block-mobile">
                    ...
                    <div className="relative md:mr-[30px]">
                        <div
                            ...
                            {/*<div className="float-left" style={{ border: 'solid 1px', background: 'yellow'}}>*/}
                    ...
                    <span className="mt-[5px] absolute top-[-3px] right-[16px] ms:ml-3 min-w-max md:right-0 md:inline-block md:mt-[5px]">
                        <a
                            href="/api/auth/signout"
                            title={t('Logout')}
                            onClick={(e) => {
