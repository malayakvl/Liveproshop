...
export default function Pricing({ locale }: { locale: any }) {
    ...
    const parseOptionsTick = (data: any, selected: string, indx: number) => {
        console.log('Plan Data', data.length);
        const selectedIndex = selected === 'basic' ? 0 : selected === 'business' ? 1 : 2;
        return (
            <>
                {data.map((_data: any) => (
                    <Fragment key={_data.option.id}>
    ...
    return (
        <>
            ...
            <div className="mt-[30px] container relative mx-auto border-red-900 xl:max-w-[1400px]">
                ...
                <div className="container-1 mx-auto mt-[100px] mb-[40px]">
                    <div className="flex w-full">
                        <div className="md:w-[40%] description-column">
                            ...
                            <Fragment>
                                {plans.values.map((values: any, key: number) => (
                                    <>
                                        ...
                                        {parseOptionsTick(values.values, 'basic', 0)}
                                    </>
                                ))}
                            </Fragment>
                        </div>
